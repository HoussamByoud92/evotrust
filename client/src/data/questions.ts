...
export const QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    text: "De quelle diaspora êtes-vous issu ?",
    type: "single",
    options: ["Marocaine", "Algérienne", "Tunisienne", "Autre"],
    required: true,
    image: "/manus-storage/img_profil_064a105f.jpg",
  },
  {
  ...
  // THÈME 2 — L'ENVIE DE MAROC
  {
    ...
    text: "À quel point envisagez-vous de venir vivre et travailler au Maroc ?",
    type: "single",
    options: ["Pas du tout", "Peut-être", "Oui, c'est mon projet"],
    required: true,
    image: "/manus-storage/img_maroc_3589d5ab.jpg",
  },
  {
    id: "q9", number: 9, theme: 2, themeLabel: "L'Envie de Maroc",
    text: "Si vous envisagez un retour, dans quel horizon de temps ?",
    type: "single",
    options: ["Dans moins d'un an", "Dans 1 à 3 ans", "Dans 3 à 5 ans", "À plus de 5 ans"],
    required: false,
    image: "/manus-storage/img_maroc_3589d5ab.jpg",
  },
  {
  ...
  // THÈME 3 — CRAINTES & FREINS
  {
    ...
    text: "Quels sont les principaux obstacles que vous identifiez pour concrétiser votre projet de retour au Maroc ? (5 choix maximum)",
    type: "multiple",
    maxChoices: 5,
    options: [
      "La rémunération",
      ...
      "L'absence d'un dispositif public dédié aux profils diaspora",
  ...
  },
  {
    ...
    options: [
      ...
      "Limitée : Je m'appuie surtout sur mes séjours au Maroc ou ce qu'en disent mes proches",
  ...
  },
  {
    ...
    type: "single",
    options: ["Oui, pleinement", "Partiellement", "Peu", "Pas du tout", "Je ne sais pas"],
    required: true,
    image: "/manus-storage/img_diaspora_ff2ca8a8.jpg",
  },
  {
    id: "q14", number: 14, theme: 3, themeLabel: "Craintes & Freins",
    text: "Si vous avez déjà essayé de trouver un emploi au Maroc depuis l'étranger, quelles ont été vos principales difficultés ? (3 choix maximum)",
    type: "multiple",
    maxChoices: 3,
    options: [
      "Pas de réponse aux candidatures",
      "Offres inadaptées à mon profil",
      "Packages proposés trop bas",
  ...
  // THÈME 5 — PERCEPTION & CONFIANCE
  {
    ...
    text: "Comment évaluez-vous la confiance que vous avez dans l'avenir économique du Maroc ?",
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      "Non, je gère ça seul·e via Internet",
  ...
  },
  {
    ...
    type: "single",
    options: ["Oui, absolument", "Pas vraiment", "Non"],
    required: true,
    image: "/manus-storage/img_cover_92b3b2c3.jpg",
  },
  {
  ...
  },
  {
    ...
    text: "Seriez-vous prêt·e à participer à un événement de networking organisé spécifiquement pour les cadres marocains à l'étranger ?",
    type: "single",
    options: ["Oui, absolument", "Peut-être", "Non"],
    required: true,
    image: "/manus-storage/img_cover_92b3b2c3.jpg",
  },
  {
    id: "q24", number: 24, theme: 5, themeLabel: "Perception & Confiance",
    text: "De quoi avez-vous besoin aujourd'hui pour envisager concrètement une mobilité vers le Maroc ? (5 choix maximum)",
    type: "multiple",
    maxChoices: 5,
    options: [
      ...
      "Un accompagnement par un cabinet qui comprend la réalité des profils diaspora",
      "Une meilleure connaissance du marché marocain — secteurs, salaires, codes professionnels",
  ...
  },
  {
    ...
    text: "Quelle est la vraie raison — celle qu'on n'ose pas toujours dire — qui vous retient de ne pas franchir le pas vers le Maroc ?",
    type: "open",
    required: false,
    image: "/manus-storage/img_cover_92b3b2c3.jpg",
  },
